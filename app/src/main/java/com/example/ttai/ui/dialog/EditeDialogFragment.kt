...
class EditeDialogFragment : DialogFragment() {
    ...
    private var _binding: DialogEditeBinding? = null
    ...
    // 设置回调
    fun setOnButtonClickListener(listener: OnButtonClickListener): EditeDialogFragment {
    ...
    companion object {
        fun newInstance(
            ...
            return EditeDialogFragment().apply {
    ...
    override fun onCreateView(
        ...
        _binding = DialogEditeBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // 设置消息
        binding.edit.hint = hint
        // 设置消息
        binding.edit.setText(message)
        ...
        binding.btnPositive.setOnClickListener {
            listener?.onPositiveClick(binding.edit.text.trim().toString())
            dismiss()
        }
